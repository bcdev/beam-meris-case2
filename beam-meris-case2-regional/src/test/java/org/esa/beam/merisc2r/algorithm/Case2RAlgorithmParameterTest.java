...
public class Case2RAlgorithmParameterTest extends TestCase {
    ...
    public void testRead() throws IOException {
        ...
        assertEquals(0.34, parameter.tsmConversionFactor, 1.0e-10);
        assertEquals(-0.24, parameter.tsmConversionExponent, 1.0e-10);
        assertEquals(0.129, parameter.chlConversionFactor, 1.0e-10);
        assertEquals(-0.5, parameter.chlConversionExponent, 1.0e-10);
        assertEquals(0.61, parameter.spectrumOutOfScopeThreshold, 1.0e-10);
        assertEquals(0.99, parameter.radiance1AdjustmentFactor, 1.0e-10);
    ...
    public void testParamsIfNotInParamsFile() throws IOException {
        ...
        assertEquals(1, parameter.radiance1AdjustmentFactor, 1.0e-10);
